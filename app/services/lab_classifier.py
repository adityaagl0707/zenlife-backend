...
MARKERS = [
    ...
    {"name": "Fasting Blood Glucose", "description": "Fasting Blood Sugar", "normal_range": "70 - 100", "unit": "mg/dL", "test_type": "blood_urine", "organs": ["Endocrine & Hormonal Health"]},
    {"name": "Homocysteine", "description": "Heart & Brain Health Indicator", "normal_range": "< 15", "unit": "µmol/L", "test_type": "blood_urine", "organs": ["Heart", "Brain & Mental Health"]},
    ...
    {"name": "Triglycerides", "description": "Circulating Blood Fat", "normal_range": "< 150", "unit": "mg/dL", "test_type": "blood_urine", "organs": ["Heart", "Endocrine & Hormonal Health"]},
    ...
    {"name": "Total Protein", "description": "Nutritional & Liver Health Marker", "normal_range": "5.7 - 8.2", "unit": "g/dL", "test_type": "blood_urine", "organs": ["Liver & Digestive Health", "Blood, Immunity & Nutrition"]},
    {"name": "Globulin", "description": "Immune & Protein Balance", "normal_range": "2.5 - 3.4", "unit": "gm/dL", "test_type": "blood_urine", "organs": ["Blood, Immunity & Nutrition"]},
    ...
    {"name": "Basophils", "description": "Allergy Response Cells", "normal_range": "0.02 - 0.10", "unit": "%", "test_type": "blood_urine", "organs": ["Blood, Immunity & Nutrition"]},
    {"name": "Monocytes", "description": "Inflammation & Repair", "normal_range": "0.20 - 1.00", "unit": "%", "test_type": "blood_urine", "organs": ["Blood, Immunity & Nutrition"]},
    {"name": "Lymphocytes", "description": "Viral Infection Defense", "normal_range": "20 - 40", "unit": "%", "test_type": "blood_urine", "organs": ["Blood, Immunity & Nutrition"]},
    {"name": "Eosinophils", "description": "Allergy & Parasite Defense", "normal_range": "0.02 - 0.50", "unit": "%", "test_type": "blood_urine", "organs": ["Blood, Immunity & Nutrition"]},
    {"name": "Vitamin D", "description": "Bone & Immune Health", "normal_range": "30 - 100", "unit": "ng/mL", "test_type": "blood_urine", "organs": ["Blood, Immunity & Nutrition", "Bone, Muscle & Joint Health"]},
    {"name": "Copper", "description": "Red Blood Cell Support", "normal_range": "80 - 155", "unit": "µg/L", "test_type": "blood_urine", "organs": ["Blood, Immunity & Nutrition"]},
    {"name": "Cortisol", "description": "Stress Hormone", "normal_range": "5 - 23", "unit": "µg/dL", "test_type": "blood_urine", "organs": ["Endocrine & Hormonal Health", "Brain & Mental Health"]},
    {"name": "Folate (B9)", "description": "Cell Growth & Repair", "normal_range": "> 5.38", "unit": "ng/mL", "test_type": "blood_urine", "organs": ["Brain & Mental Health", "Blood, Immunity & Nutrition"]},
    {"name": "DHEA", "description": "Neurosteroid & Cognitive Health", "normal_range": "106 - 464", "unit": "µg/dL", "test_type": "blood_urine", "organs": ["Endocrine & Hormonal Health"]},
    {"name": "IgE", "description": "Immune Response & Allergies", "normal_range": "< 158", "unit": "IU/mL", "test_type": "blood_urine", "organs": ["Blood, Immunity & Nutrition", "Lung & Respiratory Health"]},
    ...
    {"name": "Triglycerides / HDL", "description": "Metabolic Health Marker", "normal_range": "< 3.12", "unit": "Ratio", "test_type": "blood_urine", "organs": ["Heart", "Endocrine & Hormonal Health"]},
    ...
    {"name": "Iron % Saturation", "description": "Iron Utilization Rate", "normal_range": "13 - 45", "unit": "%", "test_type": "blood_urine", "organs": ["Blood, Immunity & Nutrition"]},
    {"name": "RBC", "description": "Red Blood Cell Count", "normal_range": "3.80 - 4.80", "unit": "x10⁶/µL", "test_type": "blood_urine", "organs": ["Blood, Immunity & Nutrition"]},
    {"name": "TPO", "description": "Autoimmune Thyroid Marker", "normal_range": "< 9", "unit": "IU/mL", "test_type": "blood_urine", "organs": ["Endocrine & Hormonal Health"]},
    ...
    {"name": "Leukocytes", "description": "Infection Marker", "normal_range": "4 - 10", "unit": "x10³/µL", "test_type": "blood_urine", "organs": ["Blood, Immunity & Nutrition"]},
    {"name": "Iron", "description": "Oxygen Transport", "normal_range": "50 - 170", "unit": "µg/dL", "test_type": "blood_urine", "organs": ["Blood, Immunity & Nutrition"]},
    {"name": "TIBC", "description": "Iron Binding Capacity", "normal_range": "215 - 535", "unit": "µg/dL", "test_type": "blood_urine", "organs": ["Blood, Immunity & Nutrition"]},
    {"name": "Vitamin A", "description": "Vision & Immunity", "normal_range": "300 - 800", "unit": "ng/mL", "test_type": "blood_urine", "organs": ["Blood, Immunity & Nutrition"]},
    {"name": "Zinc", "description": "Immunity & Healing", "normal_range": "4000 - 9000", "unit": "µg/L", "test_type": "blood_urine", "organs": ["Blood, Immunity & Nutrition"]},
    {"name": "Selenium", "description": "Antioxidant Defense", "normal_range": "60 - 340", "unit": "µg/L", "test_type": "blood_urine", "organs": ["Endocrine & Hormonal Health", "Blood, Immunity & Nutrition"]},
    {"name": "WBC", "description": "Immune Cell Count", "normal_range": "4 - 10", "unit": "x10³/µL", "test_type": "blood_urine", "organs": ["Blood, Immunity & Nutrition"]},
    {"name": "MPV", "description": "Platelet Size Indicator", "normal_range": "6.5 - 12", "unit": "fL", "test_type": "blood_urine", "organs": ["Blood, Immunity & Nutrition"]},
    {"name": "Hemoglobin", "description": "Oxygen Transport", "normal_range": "12 - 15", "unit": "g/dL", "test_type": "blood_urine", "organs": ["Blood, Immunity & Nutrition"]},
    {"name": "Platelet Count", "description": "Clotting Ability", "normal_range": "150 - 410", "unit": "x10³/µL", "test_type": "blood_urine", "organs": ["Blood, Immunity & Nutrition"]},
    {"name": "Hematocrit", "description": "Blood Cell Volume", "normal_range": "40 - 50", "unit": "%", "test_type": "blood_urine", "organs": ["Blood, Immunity & Nutrition"]},
    {"name": "MCV", "description": "Red Blood Cell Size", "normal_range": "83 - 101", "unit": "fL", "test_type": "blood_urine", "organs": ["Blood, Immunity & Nutrition"]},
    {"name": "RDW", "description": "Red Cell Variation", "normal_range": "11.6 - 14", "unit": "%", "test_type": "blood_urine", "organs": ["Blood, Immunity & Nutrition"]},
    {"name": "MCH", "description": "Hemoglobin Per Cell", "normal_range": "27 - 32", "unit": "pg", "test_type": "blood_urine", "organs": ["Blood, Immunity & Nutrition"]},
    {"name": "MCHC", "description": "Hemoglobin Concentration", "normal_range": "31.5 - 34.5", "unit": "g/dL", "test_type": "blood_urine", "organs": ["Blood, Immunity & Nutrition"]},
    {"name": "PSA", "description": "Prostate Health Marker", "normal_range": "< 4", "unit": "ng/mL", "test_type": "blood_urine", "organs": ["Men's Health"]},
    {"name": "UIBC", "description": "Unsaturated Iron-Binding Capacity", "normal_range": "162 - 368", "unit": "µg/dL", "test_type": "blood_urine", "organs": ["Blood, Immunity & Nutrition"]},
    ...
    {"name": "Bilirubin (Indirect)", "description": "Liver & RBC Health", "normal_range": "0 - 0.9", "unit": "mg/dL", "test_type": "blood_urine", "organs": ["Liver & Digestive Health", "Blood, Immunity & Nutrition"]},
    {"name": "Plateletcrit (PCT)", "description": "Platelet Volume", "normal_range": "0.19 - 0.39", "unit": "%", "test_type": "blood_urine", "organs": ["Blood, Immunity & Nutrition"]},
    {"name": "Vitamin B12", "description": "Nerve & Blood Health", "normal_range": "197 - 771", "unit": "pg/mL", "test_type": "blood_urine", "organs": ["Brain & Mental Health", "Blood, Immunity & Nutrition"]},
    {"name": "Albumin/Globulin Ratio", "description": "Liver & Immune Balance", "normal_range": "0.9 - 2.0", "unit": "Ratio", "test_type": "blood_urine", "organs": ["Liver & Digestive Health", "Blood, Immunity & Nutrition"]},
    {"name": "Albumin", "description": "Blood Protein & Fluid Balance", "normal_range": "3.2 - 4.8", "unit": "g/dL", "test_type": "blood_urine", "organs": ["Liver & Digestive Health", "Blood, Immunity & Nutrition"]},
    ...
    {"name": "Insulin", "description": "Insulin Sensitivity", "normal_range": "1.9 - 23", "unit": "µIU/mL", "test_type": "blood_urine", "organs": ["Endocrine & Hormonal Health"]},
    {"name": "HbA1c", "description": "Long-Term Blood Sugar", "normal_range": "< 5.7", "unit": "%", "test_type": "blood_urine", "organs": ["Endocrine & Hormonal Health"]},
    {"name": "TSH", "description": "Thyroid Function Regulator", "normal_range": "0.30 - 5.50", "unit": "µIU/mL", "test_type": "blood_urine", "organs": ["Endocrine & Hormonal Health"]},
    {"name": "T4 Free", "description": "Thyroid Hormone Reserve", "normal_range": "0.93 - 1.70", "unit": "ng/dL", "test_type": "blood_urine", "organs": ["Endocrine & Hormonal Health"]},
    {"name": "T3 Free", "description": "Active Thyroid Hormone", "normal_range": "2 - 4.4", "unit": "pg/mL", "test_type": "blood_urine", "organs": ["Endocrine & Hormonal Health"]},
    {"name": "Average Blood Glucose", "description": "Long-Term Sugar Control", "normal_range": "< 120", "unit": "mg/dL", "test_type": "blood_urine", "organs": ["Endocrine & Hormonal Health"]},
    {"name": "Testosterone", "description": "Hormone for Vitality", "normal_range": "280 - 800", "unit": "ng/dL", "test_type": "blood_urine", "organs": ["Endocrine & Hormonal Health"]},
    {"name": "hs-CRP", "description": "Inflammation Marker", "normal_range": "< 3", "unit": "mg/L", "test_type": "blood_urine", "organs": ["Heart", "Blood, Immunity & Nutrition"]},
    {"name": "Neutrophils", "description": "Bacterial Infection Defense", "normal_range": "40 - 80", "unit": "%", "test_type": "blood_urine", "organs": ["Blood, Immunity & Nutrition"]},
    ...
    {"name": "Ferritin", "description": "Iron Storage", "normal_range": "4.63 - 204", "unit": "ng/mL", "test_type": "blood_urine", "organs": ["Blood, Immunity & Nutrition"]},
    {"name": "Magnesium, RBC", "description": "Cellular Magnesium", "normal_range": "1.9 - 3.1", "unit": "mg/dL", "test_type": "blood_urine", "organs": ["Blood, Immunity & Nutrition", "Bone, Muscle & Joint Health"]},
    {"name": "Cortisol (Urine)", "description": "Adrenal Function", "normal_range": "4 - 176", "unit": "µg/24h", "test_type": "blood_urine", "organs": ["Endocrine & Hormonal Health"]},
    {"name": "Agatston Score", "description": "Coronary Calcium Score", "normal_range": "< 100", "unit": "", "test_type": "calcium_score", "organs": ["Heart"]},
    {"name": "Visceral Fat Area", "description": "Abdominal Fat Measurement", "normal_range": "< 100", "unit": "cm²", "test_type": "dexa", "organs": ["Endocrine & Hormonal Health", "Heart"]},
    {"name": "Gynoid Fat", "description": "Hip/Thigh Fat %", "normal_range": "< 30", "unit": "%", "test_type": "dexa", "organs": ["Endocrine & Hormonal Health"]},
    {"name": "Total Body Fat %", "description": "Overall Body Fat", "normal_range": "10 - 25", "unit": "%", "test_type": "dexa", "organs": ["Endocrine & Hormonal Health"]},
    ...
    {"name": "ApoA1", "description": "Protective Lipoprotein Carrier", "normal_range": "120 - 160", "unit": "mg/dL", "test_type": "blood_urine", "organs": ["Heart"]},
    {"name": "C-Peptide", "description": "Insulin Reserve Marker", "normal_range": "0.8 - 3.5", "unit": "ng/mL", "test_type": "blood_urine", "organs": ["Endocrine & Hormonal Health"]},
    {"name": "Fibrinogen", "description": "Clotting & Inflammation Marker", "normal_range": "200 - 400", "unit": "mg/dL", "test_type": "blood_urine", "organs": ["Vascular Health", "Blood, Immunity & Nutrition"]},
    {"name": "ESR", "description": "Inflammation Screen", "normal_range": "0 - 20", "unit": "mm/hr", "test_type": "blood_urine", "organs": ["Blood, Immunity & Nutrition"]},
    {"name": "NT-proBNP", "description": "Heart Stress Marker", "normal_range": "< 125", "unit": "pg/mL", "test_type": "blood_urine", "organs": ["Heart"]},
    {"name": "Free Testosterone", "description": "Bioavailable Testosterone", "normal_range": "9 - 30", "unit": "pg/mL", "test_type": "blood_urine", "organs": ["Endocrine & Hormonal Health"]},
    {"name": "SHBG", "description": "Sex Hormone Binding Globulin", "normal_range": "10 - 57", "unit": "nmol/L", "test_type": "blood_urine", "organs": ["Endocrine & Hormonal Health"]},
    {"name": "Estradiol (E2)", "description": "Sex Hormone for Bone & Heart", "normal_range": "20 - 150", "unit": "pg/mL", "test_type": "blood_urine", "organs": ["Endocrine & Hormonal Health"]},
    {"name": "IGF-1", "description": "Growth Hormone Axis Marker", "normal_range": "100 - 250", "unit": "ng/mL", "test_type": "blood_urine", "organs": ["Endocrine & Hormonal Health"]},
    ...
    {"name": "Phosphorus", "description": "Bone & Energy Mineral", "normal_range": "2.5 - 4.5", "unit": "mg/dL", "test_type": "blood_urine", "organs": ["Bone, Muscle & Joint Health", "Blood, Immunity & Nutrition"]},
    {"name": "Vitamin E", "description": "Antioxidant Defense", "normal_range": "5.5 - 17", "unit": "mg/L", "test_type": "blood_urine", "organs": ["Blood, Immunity & Nutrition"]},
    {"name": "Reverse T3", "description": "Inactive Thyroid Hormone", "normal_range": "10 - 24", "unit": "ng/dL", "test_type": "blood_urine", "organs": ["Endocrine & Hormonal Health"]},
    {"name": "LDH", "description": "Tissue Damage Marker", "normal_range": "140 - 280", "unit": "U/L", "test_type": "blood_urine", "organs": ["Blood, Immunity & Nutrition"]},
    {"name": "D-Dimer", "description": "Clotting Activity Marker", "normal_range": "< 0.5", "unit": "µg/mL", "test_type": "blood_urine", "organs": ["Vascular Health", "Blood, Immunity & Nutrition"]},
    ...
    {"name": "Anti-TG", "description": "Thyroid Autoimmune Marker", "normal_range": "< 115", "unit": "IU/mL", "test_type": "blood_urine", "organs": ["Endocrine & Hormonal Health", "Blood, Immunity & Nutrition"]},
    ...
    {"name": "CEA", "description": "Colorectal Cancer Marker", "normal_range": "< 3", "unit": "ng/mL", "test_type": "blood_urine", "organs": ["Liver & Digestive Health", "Blood, Immunity & Nutrition"]},
    {"name": "CA-125", "description": "Ovarian Cancer Marker", "normal_range": "< 35", "unit": "U/mL", "test_type": "blood_urine", "organs": ["Women's Health"]},
    {"name": "HOMA-IR", "description": "Insulin Resistance Score", "normal_range": "< 1.5", "unit": "index", "test_type": "blood_urine", "organs": ["Endocrine & Hormonal Health", "Vascular Health"]},
    # Imaging markers
    {"name": "Carotid CIMT", "description": "Artery Wall Thickness / Vascular Age", "normal_range": "< 0.9", "unit": "mm", "test_type": "usg", "organs": ["Vascular Health"]},
    {"name": "Carotid Plaque Score", "description": "Arterial Plaque Burden", "normal_range": "0", "unit": "score", "test_type": "usg", "organs": ["Vascular Health"]},
    {"name": "Liver Steatosis Grade", "description": "Fatty Liver Severity", "normal_range": "Grade 0", "unit": "", "test_type": "usg", "organs": ["Liver & Digestive Health", "Endocrine & Hormonal Health"]},
    ...
    {"name": "Liver Fat %", "description": "MRI-measured Liver Fat (PDFF)", "normal_range": "< 5", "unit": "%", "test_type": "mri", "organs": ["Liver & Digestive Health", "Endocrine & Hormonal Health"]},
    {"name": "White Matter Hyperintensity", "description": "Brain Small Vessel Disease Burden", "normal_range": "None", "unit": "", "test_type": "mri", "organs": ["Brain & Mental Health"]},
    {"name": "Prostate Volume", "description": "Prostate Size", "normal_range": "< 30", "unit": "cc", "test_type": "mri", "organs": ["Men's Health"]},
    ...
    {"name": "Fat Mass Index", "description": "Standardised Body Fat", "normal_range": "< 9", "unit": "kg/m²", "test_type": "dexa", "organs": ["Endocrine & Hormonal Health", "Vascular Health"]},
    {"name": "Trunk:Limb Fat Ratio", "description": "Central vs Peripheral Fat", "normal_range": "< 1.2", "unit": "ratio", "test_type": "dexa", "organs": ["Endocrine & Hormonal Health", "Vascular Health"]},
    {"name": "P-Wave Duration", "description": "Atrial Conduction Time / AF Risk", "normal_range": "< 120", "unit": "ms", "test_type": "ecg", "organs": ["Heart"]},
...
def generate_template_excel(patient=None, section=None) -> bytes:
    ...
    group_fills = {
        ...
        "Endocrine & Hormonal Health": PatternFill(start_color="FFFBF0", end_color="FFFBF0", fill_type="solid"),
        "Liver & Digestive Health": PatternFill(start_color="F0FFF4", end_color="F0FFF4", fill_type="solid"),
        "Brain & Mental Health": PatternFill(start_color="F0F4FF", end_color="F0F4FF", fill_type="solid"),
        "Kidney & Urinary Health": PatternFill(start_color="FFF0FB", end_color="FFF0FB", fill_type="solid"),
        "Blood, Immunity & Nutrition": PatternFill(start_color="FFFFF0", end_color="FFFFF0", fill_type="solid"),
        "Blood, Immunity & Nutrition": PatternFill(start_color="F5F5F5", end_color="F5F5F5", fill_type="solid"),
    ...
    if use_section_params:
        ...
        #   1. Explicit description on the SECTION_PARAMETERS entry
        #   2. MARKERS catalog (matched by canonical or alias name)
        #   3. Curated fallback dictionary for params not in MARKERS
        marker_desc_by_name = {m['name'].strip().lower(): m['description'] for m in MARKERS}
        # Also index aliases to their canonical descriptions
        for alias_lower, canonical in PARAM_SYNONYMS.items():
            d = marker_desc_by_name.get(canonical.strip().lower())
            if d:
                marker_desc_by_name.setdefault(alias_lower, d)

        FALLBACK_DESC = {
            "fasting blood glucose": "Fasting Blood Sugar",
            "average blood glucose": "3-Month Avg Glucose",
            "ketone": "Ketone Bodies (DKA Marker)",
            "hba1c": "3-Month Glucose Average",
            "insulin": "Insulin Hormone Level",
            "alp": "Liver / Bone Enzyme",
            "alkaline phosphatase": "Liver / Bone Enzyme",
            "hs-crp": "High-Sensitivity Inflammation Marker",
            "wbc": "White Blood Cell Count",
            "lymphocytes": "Viral Infection Defense",
            "lymphocytes - count": "Lymphocyte Absolute Count",
            "neutrophils": "Bacterial Defense Cells",
            "neutrophils - count": "Neutrophil Absolute Count",
            "monocytes - count": "Monocyte Absolute Count",
            "eosinophils - count": "Eosinophil Absolute Count",
            "basophils - count": "Basophil Absolute Count",
            "platelet count": "Clotting Cells",
            "plateletcrit (pct)": "Platelet Volume %",
            "plcr": "Large Platelet Ratio",
            "pdw": "Platelet Distribution Width",
            "rdw-sd": "RBC Size Variation (SD)",
            ...
            "vitamin b12": "Energy / Nerve Vitamin",
            "vitamin a": "Vision & Skin Vitamin",
            "selenium": "Antioxidant Mineral",
            "zinc": "Immune & Healing Mineral",
            "copper": "Red Cell Support Mineral",
            "iron": "Serum Iron",
            "iron % saturation": "Iron Utilization Rate",
            "calcium": "Bone & Nerve Mineral",
            "phosphorus": "Bone & Energy Mineral",
            "homocysteine": "Heart & Brain Risk Marker",
            "homocysteine levels": "Heart & Brain Risk Marker",
            "lipoprotein (a)": "Genetic Cardiac Risk",
            "apolipoprotein b": "ApoB / Bad Cholesterol Particles",
            "apoa1": "ApoA1 / Good Cholesterol Particles",
            "non-hdl cholesterol": "All Bad Cholesterol",
            "vldl cholesterol": "Triglyceride Transporter",
            "triglycerides / hdl": "Metabolic Health Ratio",
            "total cholesterol / hdl": "Heart Risk Ratio",
            "hdl/ldl ratio": "Cholesterol Ratio",
            "ldl/hdl ratio": "Bad/Good Ratio",
            ...
            "globulin": "Immune & Protein Balance",
            ...
            "bun / creatinine ratio": "Kidney Health Pattern",
            "egfr": "Estimated Filtration Rate",
            "urea (calculated)": "Calculated Urea",
            "urea/creatinine ratio": "Kidney Pattern",
            "sodium": "Sodium Level",
            "potassium": "Potassium Level",
            "chloride": "Chloride Level",
            "tsh": "Thyroid-Stimulating Hormone",
            "thyroxine (t4) free": "Free T4 Thyroid Hormone",
            "triiodothyronine (t3) free": "Free T3 Thyroid Hormone",
            "tpo": "Anti-Thyroid Antibody",
            "anti-tg": "Anti-Thyroglobulin Antibody",
            "reverse t3": "Inactive Thyroid Hormone",
            "cortisol": "Stress Hormone",
            "cortisol (urine)": "24h Cortisol Excretion",
            ...
            "afp": "Liver/Germ Cell Tumor Marker",
            "cea": "Tumor Marker (GI/lung)",
            "ldh": "Tissue Damage Marker",
            ...
            "pt / inr": "Blood Clotting Time",
            "esr": "Sedimentation Rate (Inflammation)",
            "c-peptide": "Insulin Production Marker",
            "homa-ir": "Insulin Resistance Index",
            "fat mass index": "Body Fat Index",
            "trunk:limb fat ratio": "Central Fat Distribution",
            "liver fat %": "Liver Fat Percentage",
            "liver steatosis grade": "Fatty Liver Severity",
            "vitamin d": "Bone & Immune Vitamin",
            "vitamin e": "Antioxidant Vitamin",
            "folate (b9)": "Cell Growth Vitamin",
            "ige": "Allergy Antibody",
            "pap smear": "Cervical Cancer Screening",
            "hpv dna test": "HPV Genotype Test",
            "cystatin c": "Kidney Function Marker",
            "pth": "Parathyroid Hormone",
            "asmi": "Skeletal Muscle Index",
            "rbc": "Red Blood Cell Count",
            "lymphocyte %": "Lymphocyte Percentage",
            "lymphocytes %": "Lymphocyte Percentage",
            "nucleated rbc": "Immature RBC Count",
            "nucleated rbc %": "Immature RBC %",
            "immature granulocytes": "Bone Marrow Activity",
            "immature granulocytes %": "Bone Marrow Activity %",
            "average blood glucose": "Estimated Average Glucose",
            # Urine
            "urine albumin/creatinine": "Kidney Function Marker",
            "urinary microalbumin": "Early Kidney Damage Marker",
            "urinary leucocytes": "Urine WBC",
            "mucus": "Urinary Mucus",
            "parasite": "Urinary Parasites",
            "urine ketone": "Urinary Ketones",
            "epithelial cells": "Urinary Epithelial Cells",
            "crystals": "Urinary Crystals",
            "colour": "Urine Colour",
            "casts": "Urinary Casts",
            "bile salt": "Urinary Bile Salts",
            "bile pigment": "Urinary Bile Pigments",
            "ph": "Urine pH",
            "urinary protein": "Urine Protein",
            "red blood cells": "Urinary RBC",
            "yeast": "Urinary Yeast",
            "bacteria": "Urinary Bacteria",
            "urinary bilirubin": "Urinary Bilirubin",
            "urine blood": "Urinary Blood",
            "urinary glucose": "Urinary Glucose",
            "creatinine urine": "Urine Creatinine",
            "leucocyte esterase": "WBC Enzyme (UTI Marker)",
            "nitrite": "Nitrite (UTI Marker)",
            "specific gravity": "Urine Concentration",
            "appearance": "Urine Appearance",
        }

        def resolve_desc(name: str) -> str:
            n = (name or "").strip().lower()
            return marker_desc_by_name.get(n) or FALLBACK_DESC.get(n, "")

        # Wrap as the same shape as MARKERS so the loop below works
        markers_iter = [
            {
                "name": p["name"],
                "description": p.get("description") or resolve_desc(p["name"]),
